...
browser.runtime.sendMessage({message:'sendurlforrt'});
...
//          });
        ...
        function openTheUrl(d){
          ...
          //browser.runtime.sendMessage({message:'openurl',url:wayback_url});
            browser.runtime.sendMessage({message:'openurl',wayback_url: wb_url,page_url:url});
        }
